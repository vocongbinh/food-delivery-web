...
interface SettingOption {
    ...
    icon: ReactNode;
    title: string;
    component: ({ user }: { user: UserInfo }) => React.JSX.Element;
}
...
const Settings = () => {
    ...
    const { data, isLoading } = useQuery({ queryKey: ["profile"], queryFn: () => AuthsApi.getUserProfile() })
            ...
            <div className='container bg-white py-10'>
                <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="col-span-3">
                        <Component user={data as UserInfo} />
                    </div>
                </div>
            </div>
        )
