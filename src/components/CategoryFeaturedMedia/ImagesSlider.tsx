...
export default function ImagesSlider({
  ...
  return (
    ...
    >
      <div
        className={` group group/cardImagesSlider ${className}`}
        {...handlers}
      >
        {/* Main image */}
        ...
        <>
          {/* Buttons */}
          {loaded && navigation && (
            <div className="opacity-0 group-hover/cardImagesSlider:opacity-100 transition-opacity ">
              {index > 0 && (
                <button
