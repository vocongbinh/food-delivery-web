...
import { Order, OrderNFT, OrderOfContract, OrderRequest, PutOrderRequest } from "@/types/order";
...
export class OrdersApi {
  ...
  static async getJettons(walletAddress: string) {
    const res = await axios.get(`https://testnet.tonapi.io/v2/accounts/${walletAddress}/jettons?currencies=ton,usd,rub&supported_extensions=custom_payload`)
